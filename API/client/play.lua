...
RegisterNetEvent("rs_sounds:playSound")
AddEventHandler("rs_sounds:playSound", function(name,url,vol,loop)
    PlayUrl(name,url,vol,loop)
end)

RegisterNetEvent("rs_sounds:stopSound")
AddEventHandler("rs_sounds:stopSound", function(name)
    Destroy(name)
end)
