                        ...
                        if DoesEntityExist(bag) then
                            if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), GetEntityCoords(bag), true) <= 1.5 then
                                ...
                                if IsControlJustPressed(0, 51) then 
                                    ...
                                    StopSound(eSup.IsRobbing)
                                    ReleaseScriptAudioBank("Alarms")
                                    AeroEvent('eSup:PickupRobbery', eSup.Braquage[i], i)
                                    SetFakeWantedLevel(0)
                                    break
                                end
                            end
    ...
    Citizen.CreateThread(function()
        while true do
            for i = 1, #eSup.Peds do
                if IsPedDeadOrDying(eSup.Peds[i]) then
                    AeroEvent('eSup:PedDeadRobbery', i)
                end
            end
            Wait(5000)
        end
                        ...
                        if not eSup.IsRobbing then
                            ...
                            if canRob == true then
                                ...
                                if chance >= 0 and chance <= 25 then
                                    ...
                                    AeroEvent("sCall:SendCallMsg", "Braquage de supérette", eSup.Braquage[i].coords, "police", false)
                                    AeroEvent("sCall:SendCallMsg", "Braquage de supérette", eSup.Braquage[i].coords, "lssd", false)
