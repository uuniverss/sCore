        ...
        while Fleeca.nFleeca ~= 0 do
            ...
            if Fleeca.moove == 1 then
                ...
                if disTance < 1.3 then
                    ESX.ShowHelpNotification("Appuyez sur ~INPUT_CONTEXT~ pour utiliser votre ~g~perceuse.")
...
AddEventHandler("cFleeca:BinginDrill", function()
    AeroEvent("sCall:SendCallMsg", "Braquage de banque", GetEntityCoords(PlayerPedId()), "police", false)
    AeroEvent("sCall:SendCallMsg", "Braquage de banque", GetEntityCoords(PlayerPedId()), "lssd", false)
