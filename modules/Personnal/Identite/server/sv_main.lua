...
AddEventHandler('esx_vehiclelock:deletekeyjobs', function(target, plate)
	local _src = source
	--TriggerEvent("ratelimit", _src, "esx_vehiclelock:deletekeyjobs")
...
AddEventHandler('esx_vehiclelock:givekey', function(target, plate)
	local _src = source
	--TriggerEvent("ratelimit", _src, "esx_vehiclelock:givekey")
	local _source = source
	local xPlayer
...
AddEventHandler('esx_vehiclelock:registerkey', function(plate, donated, target)
	local _src = source
	--TriggerEvent("ratelimit", _src, "esx_vehiclelock:registerkey")
	local _source = source
	local xPlayer
...
AddEventHandler('esx_vehiclelock:changeowner', function(target, plate, vehicleProps)
	local _src = source
	--TriggerEvent("ratelimit", _src, "esx_vehiclelock:changeowner")
	local xPlayer = ESX.GetPlayerFromId(source)
