                    ...
                    if IsControlJustReleased(0, 38) then
                        ESX.TriggerServerCallback('Sneakyburgershot:getItemAmount', function(steaks)
                            if steaks > 0 then
                                ...
                                FreezeEntityPosition(PlayerPedId(), false)
                                ClearPedTasks(PlayerPedId())
                                SneakyEvent("Burgershot:Removeitem","viande_2",1,"steaks_cuit",1)
                            else
                                tomate = false
                                salade = false
                                steak = false
...
local garageburgershot = {
	...
	garageburgershot = {
        vehs = {
            {label = "Speedo Pearls", veh = "nspeedo", stock = 2},
            {label = "Scooter Pearls", veh = "nspeedo", stock = 4},
        },
        pos  = {
            {pos = vector3(-1791.619677734,-1195.138024902344,13.01926040649), heading = 44.784},
            --{pos = vector3(-1165.8779296875,-888.15863037109,13.0117874146), heading = 121.10},
        },
    },
}
...
local Burger = {
	PositionGarage = {
        {coords = vector3(-1793.85404052734,-1198.96857910156,13.078200340271-0.9)},
    },
	PositionDeleteGarage = {
        {coords = vector3(-1790.1668457031,-1197.588031005859,13.0923447608948-0.9)},
    },
}

GarageBurger = {}
RMenu.Add('garageburgershot', 'main', RageUI.CreateMenu("", "",nil,nil,"root_cause","burgershot"))
RMenu:Get('garageburgershot', 'main'):SetSubtitle("~c~Burgers~s~")
...
function OpenBurgerActionMenuRageUIMenu()
    local mainMenu = RageUI.CreateMenu("", "~b~Pearls~s~", 0, 0,"root_cause","burgershot")
