...
RMenu:Get('harmonyvestiaire', 'main'):SetSubtitle("~g~Actions disponibles")
...
RMenu:Get('harmonyshop', 'main'):SetSubtitle("~g~Produits disponibles")
...
RMenu:Get('harmonygarage', 'main'):SetSubtitle("~g~Actions disponibles")
...
AddEventHandler('harmony:targetAnnounce', function(announce)
    if announce == 'ouvert' then
        ESX.ShowAdvancedNotification("Harmony Repair's and Custom's", '~g~Informations', "- Mécano ~g~ouvert~s~~n~- Horaire : ~g~Maintenant", "CHAR_HARMONY", 1)
    elseif announce == 'fermeture' then
        ESX.ShowAdvancedNotification("Harmony Repair's and Custom's", '~g~Informations', "- Mécano ~r~fermé~s~~n~- Horaire : ~g~Maintenant", "CHAR_HARMONY", 1)
    end
end)