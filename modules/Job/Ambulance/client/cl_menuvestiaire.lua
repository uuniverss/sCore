...
local Ambulance = {
	PositionVestiaire = {
        {coords = vector3(298.69378051758,-598.039287109,43.292755126953-0.9)},
...
--		{coords = vector3(1824.7069091797,3673.0632324219,34.277366638184-0.9)},
	...
	PositionGarage = {
		...
		{coords = vector3(333.045846557617,-564.96451904297,28.844074249268-0.9)}
    },
	PositionGarage2 = {
...
--		{coords = vector3(1819.1116943359,3689.2385253906,33.617748260498-0.9)},
	...
	PositionDeleteGarageHelico = {
        {coords = vector3(352.00885009766,-587.97564697266,74.553367614746-0.9)},
--		{coords = vector3(1864.6551513672,3650.4067382812,36.034397125244-0.9)},
    },
	PositionVestiairePatient = {
		{coords = vector3(331.6087036133,-577.836171875,43.281585693359-0.9)},
		...
		men = {
			{
				...
				cloths = {
					...
					['torso_1'] = 508,   ['torso_2'] = 0,
					['decals_1'] = 0,   ['decals_2'] = 0,
					['arms'] = 15,
					['pants_1'] = 61,   ['pants_2'] = 5,
					['shoes_1'] = 113,   ['shoes_2'] = 3,
		...
		men = {
			{
				...
				cloths = {
					['tshirt_1'] = 239,  ['tshirt_2'] = 0,
					['torso_1'] = 493,   ['torso_2'] = 6,
					['decals_1'] = 0,   ['decals_2'] = 0,
					['arms'] = 86,
					['pants_1'] = 129,   ['pants_2'] = 0,
					['shoes_1'] = 25,   ['shoes_2'] = 0,
--					['helmet_1'] = -1,  ['helmet_2'] = 0,
					['chain_1'] = 172,    ['chain_2'] = 0,
					['ears_1'] = -1,     ['ears_2'] = 0,
					['mask_1'] = -1,     ['mask_2'] = 0,
					['bags_1'] = -1,     ['bags_2'] = 0,
					['bproof_1'] = 62,     ['bproof_2'] = 0
		...
		men = {
			{
				...
				cloths = {
					['tshirt_1'] = 239,  ['tshirt_2'] = 0,
					['torso_1'] = 514,   ['torso_2'] = 24,
					['decals_1'] = 0,   ['decals_2'] = 0,
					['arms'] = 85,
					['pants_1'] = 129,   ['pants_2'] = 4,
					['shoes_1'] = 25,   ['shoes_2'] = 0,
--					['helmet_1'] = -1,  ['helmet_2'] = 0,
					['chain_1'] = 172,    ['chain_2'] = 0,
					['ears_1'] = 0,     ['ears_2'] = 0,
...
--[[	
	clothsmedecinchef = {
		men = {
			{
				grade = "Polo Rouge Sorti Médecin", -- que pour médecin-chef
				cloths = {
					['tshirt_1'] = 230,  ['tshirt_2'] = 0,
					['torso_1'] = 515,   ['torso_2'] = 24,
					['decals_1'] = 0,   ['decals_2'] = 0,
					['arms'] = 85,
					['pants_1'] = 148,   ['pants_2'] = 0,
					['shoes_1'] = 54,   ['shoes_2'] = 0,
                    ...
                    if GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_m_freemode_01") then
                        if pGrade == "Recrue" then
                            for k,v in pairs(Clothsambulance.clothsrecrueml.men) do
                                RageUI.Button("Tenue de ~y~"..v.grade, nil, {RightLabel = "→"}, true, function(h,a,s)
                                    if s then
...
--[[                            for k,v in pairs(Clothsambulance.clothsgilet.men) do
                        ...
                        if pGrade == "Ambulancier-Chef" then
                            for k,v in pairs(Clothsambulance.clothsinfirmier.men) do
                                RageUI.Button("Tenue de ~y~"..v.grade, nil, {RightLabel = "→"}, true, function(h,a,s)
                                    if s then
                                        TriggerEvent('Sneakyskinchanger:getSkin', function(skin)
...
--[[                            for k,v in pairs(Clothsambulance.clothsgilet.women) do
				...
				RageUI.IsVisible(RMenu:Get('ambulancevestiaire', 'accessories'), true, false, true, function()
					if GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_m_freemode_01") then
						for k,v in pairs(configambulance.clothsaccessories0.men) do
						...
						for k,v in pairs(configambulance.clothsaccessories0.women) do
							RageUI.Button("Accessoire : ~g~"..v.grade, nil, {RightLabel = "→"}, true, function(h,a,s)
								if s then
									TriggerEvent('Sneakyskinchanger:getSkin', function(skin)
										TriggerEvent('Sneakyskinchanger:loadClothes', skin, v.cloths)
					...
					if GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_m_freemode_01") then
						for k,v in pairs(configambulance.clothsaccessories2.men) do
							RageUI.Button("Accessoire : ~g~"..v.grade, nil, {RightLabel = "→"}, true, function(h,a,s)
								if s then
									TriggerEvent('Sneakyskinchanger:getSkin', function(skin)
										TriggerEvent('Sneakyskinchanger:loadClothes', skin, v.cloths)
						...
						for k,v in pairs(configambulance.clothsaccessories2.women) do
							RageUI.Button("Accessoire : ~g~"..v.grade, nil, {RightLabel = "→"}, true, function(h,a,s)
								if s then
									TriggerEvent('Sneakyskinchanger:getSkin', function(skin)
										TriggerEvent('Sneakyskinchanger:loadClothes', skin, v.cloths)
        ...
        for k,v in pairs(Ambulance.PositionVestiaire) do
            ...
            if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'ambulance' then
                if not AmbulanceVestiaire.Menu then
                    if mPos <= 4.0 then
                        att = 1
--                        DrawText3D(v.coords.x, v.coords.y, v.coords.z+2, "Appuyez sur ~g~E~s~ pour accéder au ~g~vestiaire~s~.", 9)
                        if mPos <= 2.0 then
        ...
        for k,v in pairs(Ambulance.PositionVestiairePatient) do
            ...
            if not AmbulanceVestiairePatient.Menu then
                if mPos <= 10.0 then
                    att = 1
					if mPos <= 3.5 then
                    	DrawText3D(v.coords.x, v.coords.y, v.coords.z+2, "Appuyez sur ~g~E~s~ pour prendre une ~g~blouse~s~.", 9)
					end
					if mPos <= 3.5 then
            ...
            if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'ambulance' then
                if not AmbulanceGarage.Menu then
                    if mPos <= 10.0 then
                        ...
                        if mPos <= 1.5 then
							if onService then
								DrawText3D(v.coords.x, v.coords.y, v.coords.z+2, "Appuyez sur ~g~E~s~ pour accéder au ~g~garage~s~.", 9)
...
local garageambulance = {
	...
	garageambulance = {
        vehs = {
            {label = "Fourgon Ambulance", veh = "LSFDamb3", stock = 4},
			{label = "Vapid Ambulance", veh = "emsnspeedo", stock = 4},
			{label = "Caracara Supervisor", veh = "ambucara", stock = 3},
        },
        pos  = {
            {pos = vector3(320.74501953,-565.378417969,28.757567596436), heading = 252.37},
			{pos = vector3(319.27340087891,-569.83172851562,28.757065963745), heading = 252.37},
			{pos = vector3(317.49366455078,-573.81572265625,28.762477111816), heading = 252.37},
			{pos = vector3(315.78927001953,-578.07510986328,28.759635162354), heading = 252.37},
        },
    },
}
