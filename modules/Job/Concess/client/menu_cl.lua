...
local CarDealer = {
     [1] = {
          ...
          Positions = {
               key = vector3(-1259.9831732177734,-368.8531982422,36.9274415969849),
               caisse = vector3(-1257.24861583709717,-369.428417969,36.9274324417114),
               catalogue = vector3(-1254.1707164764404,-349.229833984,36.9274415969849),
               visualVeh = vector3(-1252.9252632141113,-357.484521484,36.92309036255),
               visualHeading = 63.06,
               spawnVeh = vector3(-1236.015340423584,-350.963476563,36.33776779175),
               spawnHeading = 350.13
          },
          Vehicles = {
               [1] = {
               ...
               [2] = {
                    ...
                    List = {
                         ...
                         {name = "kanjosj", price = 13500 },
                         {name = "oracle", price = 21500 },
                         {name = "oracle2", price = 20250 },
                         {name = "postlude", price = 11300 },
                         {name = "previçon", price = 11600 },
               ...
               [3] = {
                    ...
                    List = {
                         ...
                         {name = "primo2", price = 20693 },
                         {name = "regina", price = 9400 },
                         {name = "rhinehart", price = 74600 },
                         {name = "schafter2", price = 35200 },
                         {name = "schafter3", price = 48200 },
                         {name = "schafter4", price = 56200 },
                         {name = "stafford", price = 52000 },
                         {name = "stanier", price = 16460 },
                         {name = "stratum", price = 11500 },
                         {name = "stretch", price = 71500 },
                         {name = "superd", price = 52000 },
                         {name = "surge", price = 9500 },
                         {name = "tailgater", price = 13210 },
                         {name = "tailgater2", price = 47210 },
                         {name = "warrener", price = 11600 },
                         {name = "warrener2", price = 15600 },
               ...
               [4] = {
                    ...
                    Desc = "Véhicules ~g~Sports Classic~s~",
                    List = {
                         {name = "190z", price = 74000 },
                         {name = "ardent", price = 66400 },
                         {name = "btype", price = 76000 },
                         {name = "btype2", price = 73000 },
                         {name = "btype3", price = 75000 },
                         {name = "casco", price = 46000 },
                         {name = "cheburek", price = 30000 },
                         {name = "cheetah2", price = 68000 },
                         {name = "coquette2", price = 63000 },
                         {name = "dynasty", price = 24000 },
                         {name = "fagaloa", price = 21500 },
                         {name = "feltzer3", price = 75000 },
                         {name = "gt500", price = 75000 },
                         {name = "infernus2", price = 82000 },
                         {name = "jb700", price = 76500 },
                         {name = "jb7002", price = 83800 },
                         {name = "mamba", price = 64000 },
                         {name = "manana", price = 12500 },
                         {name = "manana2", price = 18500 },
                         {name = "michelli", price = 32000 },
                         {name = "monroe", price = 62000 },
                         {name = "nebula", price = 34000 },
                         {name = "peyote", price = 20500 },
                         {name = "peyote2", price = 26000 },
                         {name = "pigalle", price = 31160 },
                         {name = "rapidgt3", price = 39100 },
                         {name = "retinue", price = 28200 },
                         {name = "retinue2", price = 29700 },
                         {name = "savestra", price = 29050 },
                         {name = "stinger", price = 58000 },
                         {name = "stingergt", price = 63000 },
                         {name = "swinger", price = 51000 },
                         {name = "torero", price = 63650 },
                         ...
                         {name = "turismo2", price = 71000 },
                         {name = "viseris", price = 66000 },
                         {name = "z190", price = 59600 },
                         {name = "ztype", price = 87000 },
                         {name = "zion3", price = 30800 },
          ...
          Vehicles = {
               ...
               [4] = {
                    ...
                    List = {
                         ...
                         {name = "faggio2", price = 1400},
                         {name = "faggio3", price = 1500},
...
local function openCarDealerMenuCatalogue(table)
     if openedMenu then
          ...
          openedMenu = true
          if ESX.PlayerData.job.name ~= table.Job then
               RMenu:Get("cardealer", "main-catalogue"):SetSubtitle(table.Label.." - ~g~Catalogue~s~")
                    ...
                    RageUI.IsVisible(RMenu:Get("cardealer", "main-catalogue"), true, false, false, function()
                         if not cooldownCarDealer then
                              for i=1, #table.Vehicles, 1 do
                                   RageUI.Button("Catégorie : ~g~"..table.Vehicles[i].Label, nil, {RightLabel = "→→"}, not cooldownCarDealer, function(h, a, s)
                                        if s then
                         ...
                         if listVehicles ~= nil then
                              if #listVehicles == 0 then
                                   ...
                                   for k,v in pairs(listVehicles) do
                                        PU = v.price
                                        PV = v.price*1.25
                                        RageUI.Button(GetLabelText(GetDisplayNameFromVehicleModel(v.name)).." Prix d'usine: "..ESX.Math.GroupDigits(PU).."~g~$~s~", "Prix de vente: "..ESX.Math.GroupDigits(PV).."~g~$~s~", {RightLabel = "~g~Attribuer~s~ →"}, true, function(h, a, s)
                                             if s then
                                                  ...
                                                  if not ESX.Game.IsSpawnPointClear(table.Positions.spawnVeh, 3.0) then
                                                       ...
                                                       ESX.Game.SpawnVehicle(v.name, table.Positions.spawnVeh, table.Positions.spawnHeading, function(vehicle)
                                                            ...
                                                            RageUI.Popup({message = "Véhicule "..GetLabelText(GetDisplayNameFromVehicleModel(v.name)).." [~g~"..newPlate.."~s~] atrribué à ~g~"..GetPlayerName(closestPly).."~s~ !"})
                                                            openedMenu = false
                                                            RageUI.CloseAll()
                                                            FreezeEntityPosition(PlayerPedId(), false)
                         ...
                         RageUI.IsVisible(RMenu:Get("cardealer", v.Name), true, false, false, function()
                              for k,v in pairs(v.List) do
                                   ...
                                   if ESX.PlayerData.job.name == table.Job then
                                        ...
                                        RageUI.Button(GetLabelText(GetDisplayNameFromVehicleModel(v.name)), "Prix : "..PV.."~g~$~s~", {RightLabel = "→ ~g~Voir"}, true,function(h,a,s)
                                             if s then
                                                  if localVeh ~= GetHashKey(v.name) then
                                                       TriggerEvent('persistent-vehicles/forget-vehicle', Entity)
                                                       DeleteEntity(Entity)
...
local function openCarDealerMenuKey(table)
     if openedMenu then
          ...
          FreezeEntityPosition(PlayerPedId(), true)
          openedMenu = true
          RMenu:Get("cardealer", "main-key"):SetSubtitle(table.Label..' - ~g~Clés~s~')
                    ...
                    RageUI.IsVisible(RMenu:Get("cardealer", "main-key"), true, false, false, function()
                         if #getkeys == 0 then
                              ...
                              for k,v in pairs(getkeys) do
                                   ...
                                   RageUI.Button(donatedLabel..v.label, nil, {RightLabel = "~g~Créer~s~ →"}, true, function(h, a, s)
                                        if s then
                                             SneakyEvent('esx_vehiclelock:registerkey', v.value, v.donated, 'no')
...
function OpenConcessActionMenuRageUIMenu()
    ...
    if ConcessActionMenu.Menu then 
	   ...
	   RMenu.Add('concessactionmenu', 'action', RageUI.CreateSubMenu(RMenu:Get("concessactionmenu", "main"),"", "~g~Legendary Motorsport"))
        RMenu.Add('concessactionmenu', 'facture', RageUI.CreateSubMenu(RMenu:Get("concessactionmenu", "action"),"", "~g~Legendary Motorsport"))
        RMenu:Get('concessactionmenu', 'main'):SetSubtitle("~g~Legendary Motorsport")
                              ...
                              RageUI.Button("Fourrière", nil, { RightLabel = "→" },true, function(h,a,s)
                                   if s then
                                        ...
                                        if not impound then
                                             ...
                                             ESX.ShowHelpNotification("Vous êtes en train de mettre en fourrière le ~g~véhicule~s~.")
