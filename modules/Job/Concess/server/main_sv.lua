    ...
    if _src then
        ...
        elseif Type == "reduc" then
            TriggerClientEvent(
                ...
                Title,
                Subtitle,
                "- Remise disponible : ~g~10%~s~~n~- Durée : ~g~1h00",
                Banner
            )
        end
    end
...
AddEventHandler('sCardealer:addVehicule', function(Job, label, vehicle, price)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', "society_"..Job, function(Society)
        ...
        if SocietyMoney >= price then
            ...
            exports.sCore:SendLogs(1752220,"Achat de véhicule",""..GetPlayerName(source).." vient d'acheter le véhicule : **"..label.."** ***"..vehicle.."*** au prix de (**"..price.."**) avec le métier : ***"..Job.."*** \n License de la source : "..xPlayer.identifier,"https://discord.com/api/webhooks/1151181886283055246/YxTGaIENNC3ZmjK2zvqOpVvWLnNeSdgUT45cqGZ-rJ4f2tBqtVDGLJ7reFEw15aerH6m")
            TriggerClientEvent('esx:showNotification', source, "Vous avez acheter un(e) ~g~"..label.."~s~ pour ~g~"..price.."$ ~s~!")    
        else
