...
MecanoMenu = {
    ...
    PositionVestiaire = {
        {coords = vector3(-1424.6708984375,-457.79574584961,35.909736633301-0.9)},
    },
	PositionKitRepa = {
        {coords = vector3(-1424.5252685547,-441.75344848633,35.897602081299-0.9)},
    },
	PositionGarage = {
        {coords = vector3(-1397.8884277344,-449.0048828125,34.482215881348-0.9)},
    },
	PositionDeleteGarage = {
        {coords = vector3(-1395.8295898438,-462.64443969727,34.478866577148-0.9)},
    },
}
...
RMenu:Get('mecanovestiaire', 'main'):SetSubtitle("~g~Actions disponibles")
...
RMenu:Get('mecanoshop', 'main'):SetSubtitle("~g~Produits disponibles")
...
local Garagemecano = {
	...
	garagebennys = {
        ...
        pos  = {
            {pos = vector3(-1397.3527832031,-459.28231811523,34.481086730957), heading = 270.24},
        },
    },
}
...
RMenu:Get('mecanogarage', 'main'):SetSubtitle("~g~Actions disponibles")
						...
						if s then
							...
							if DoesEntityExist(vehicle) then
								...
								Citizen.CreateThread(function()
									...
									ESX.ShowNotification("Hayes Auto véhicule dévérouillé")
								end)
							else
...
AddEventHandler('mecano:targetAnnounce', function(announce)
    if announce == 'ouvert' then
        ESX.ShowAdvancedNotification('Mécano', '~g~Informations', "- Mécano ~g~ouvert~s~~n~- Horaire : ~g~Maintenant", "CHAR_MP_MECHANIC", 1)
    elseif announce == 'fermeture' then
        ESX.ShowAdvancedNotification('Mécano', '~g~Informations', "- Mécano ~r~fermé~s~~n~- Horaire : ~g~Maintenant", "CHAR_MP_MECHANIC", 1)
    end
end)
