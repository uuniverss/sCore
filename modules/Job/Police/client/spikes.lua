...
Citizen.CreateThread(function()
    AeroEvent("mmtirespikes:GetMissingSpikes")
end)
...
RegisterNetEvent("mmtirespike:AddSpike", function()
    ...
    Citizen.Wait(800)
    AeroEvent("mmtirespikes:CreateSpike", data)
    Citizen.Wait(200)
