...
AnimList.Animations = {
   ...
   ["beast"] = {"anim@mp_fm_event@intro", "beast_transform", "Dinosaure", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 5000,
   }},
   ...
   ["cloudgaze"] = {"switch@trevor@annoys_sunbathers", "trev_annoys_sunbathers_loop_girl", "Couché 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["cloudgaze2"] = {"switch@trevor@annoys_sunbathers", "trev_annoys_sunbathers_loop_guy", "Allonger sur le dos", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["prone"] = {"missfbi3_sniping", "prone_dave", "Discussion allongée", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["idledrunk3"] = {"missarmenian2", "standing_idle_loop_drunk", "Bourré", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["argue"] = {"misscarsteal4@actor", "actor_berating_loop", "S'énerver", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["argue2"] = {"oddjobs@assassinate@vice@hooker", "argue_a", "S'énerver 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["bartender"] = {"anim@amb@clubhouse@bar@drink@idle_a", "idle_a_bartender", "Bras posés", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["curtsy"] = {"anim@mp_player_intcelebrationpaired@f_f_sarcastic", "sarcastic_left", "Danse gracieuse"},
   ["bringiton"] = {"misscommon@response", "bring_it_on", "Bienvenue", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000
   }},
   ...
   ["cop2"] = {"anim@amb@nightclub@peds@", "rcmme_amanda1_stand_loop_cop", "Attendre bras croisés 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["cop3"] = {"amb@code_human_police_investigate@idle_a", "idle_b", "Attendre / parler talkie", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["attraper"] = {"mini@prostitutes@sexlow_veh","low_car_sex_loop_player", "Tenir quelqu'un (en voiture)", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["crossarmsside"] = {"rcmnigel1a_band_groupies", "base_m2", "Bras croisé de côté", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["fightme"] = {"anim@deathmatch_intros@unarmed", "intro_male_unarmed_c", "Se chauffer 2"},
   ["fightme2"] = {"anim@deathmatch_intros@unarmed", "intro_male_unarmed_e", "Se chauffer"},
   ...
   ["handshake2"] = {"mp_ped_interaction", "handshake_guy_b", "Check 2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 3000
   }},
   ...
   ["wait9"] = {"rcmjosh2", "josh_2_intp1_base", "Acouder 5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["jazzhands"] = {"anim@mp_player_intcelebrationfemale@jazz_hands", "jazz_hands", "Coucou", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 6000,
   }},
   ["jog2"] = {"amb@world_human_jog_standing@male@idle_a", "idle_a", "Courrir 1", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["jog3"] = {"amb@world_human_jog_standing@female@idle_a", "idle_a", "Courrir 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["jumpingjacks"] = {"timetable@reunited@ig_2", "jimmy_getknocked", "Flexions / extensions", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["knock2"] = {"missheistfbi3b_ig7", "lift_fibagent_loop", "Frapper la porte", AnimationOptions =
   {
       EmoteLoop = true,
   }},
...
--   }},
   ...
   ["leanside03"] = {"anim@amb@clubhouse@bar@bartender@","base_bartender", "Accouder sur l'arrière 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["leanside05"] = {"switch@michael@sitting_on_car_bonnet","sitting_on_car_bonnet_loop", "Accouder sur l'arrière", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ...
   ["mechanic"] = {"mini@repair", "fixing_a_ped", "Réparation moteur", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
...
--   }},
   ...
   ["point"] = {"gestures@f@standing@casual", "gesture_point", "Pointer 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["pushup"] = {"amb@world_human_push_ups@male@idle_a", "idle_d", "Faire des pompes 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["pointright"] = {"mp_gun_shop_tut", "indicate_right", "Pointer", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["scared"] = {"random@domestic", "f_distressed_loop", "Effrayer 4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["scared2"] = {"random@homelandsecurity", "knees_loop_girl", "Effrayer 5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["shrug"] = {"gestures@f@standing@casual", "gesture_shrug_hard", "Pourquoi ?", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 1000,
   }},
   ["shrug2"] = {"gestures@m@standing@casual", "gesture_shrug_hard", "Pourquoi ? 2", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteDuration = 1000,
   }},
   ...
   ["sitscared"] = {"anim@heists@ornate_bank@hostages@hit", "hit_loop_ped_b", "Effrayer", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitscared2"] = {"anim@heists@ornate_bank@hostages@ped_c@", "flinch_loop", "Effrayer 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["sitscared3"] = {"anim@heists@ornate_bank@hostages@ped_e@", "flinch_loop", "Effrayer 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["stickup"] = {"random@countryside_gang_fight", "biker_02_stickup_loop", "Braquage stressé", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["type"] = {"anim@heists@prison_heiststation@cop_reactions", "cop_b_idle", "Taper sur ordi", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["type2"] = {"anim@heists@prison_heistig1_p1_guard_checks_bus", "loop", "Taper sur ordi 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["type3"] = {"mp_prison_break", "hack_loop", "Taper sur ordi 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["type4"] = {"mp_fbi_heist", "loop", "Taper sur ordi 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["ceinturons"] = {"amb@code_human_wander_idles_cop@male@static", "static", "Mains sur la ceinture", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["SigneLocura"] = {"mp_player_int_uppergang_sign_a","mp_player_int_gang_sign_a", "Signe gang", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["SigneF4L"] = {"amb@code_human_in_car_mp_actions@gang_sign_b@low@ps@base","idle_a", "Signe gang 1", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["SigneVagos"] = {"amb@code_human_in_car_mp_actions@v_sign@std@rds@base","idle_a", "Signe gang 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["SigneVagos2"] = {"mp_player_int_upperv_sign","mp_player_int_v_sign", "Signe gang 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["SigneBallas"] = {"mp_player_int_uppergang_sign_b","mp_player_int_gang_sign_b", "Signe gang 4", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["SigneMarabunta"] = {"mp_player_int_uppergang_sign_a","mp_player_int_gang_sign_a", "Signe gang 5", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["slide"] = {"anim@arena@celeb@flat@solo@no_props@", "slide_a_player_a", "Glissade"},
   ["slide2"] = {"anim@arena@celeb@flat@solo@no_props@", "slide_b_player_a", "Glissade 2"},
   ["slide3"] = {"anim@arena@celeb@flat@solo@no_props@", "slide_c_player_a", "Glissade 3"},
   ["slugger"] = {"anim@arena@celeb@flat@solo@no_props@", "slugger_a_player_a", "Baseball"},
   ["flipoff"] = {"anim@arena@celeb@podium@no_prop@", "flip_off_a_1st", "Doigt à tout le monde", AnimationOptions =
   {
       EmoteMoving = true,
   }},
   ["flipoff2"] = {"anim@arena@celeb@podium@no_prop@", "flip_off_c_1st", "Doigt à tout le monde 2", AnimationOptions =
   {
       EmoteMoving = true,
   }},
   ...
   ["cpr"] = {"mini@cpr@char_a@cpr_str", "cpr_pumpchest", "Massage cardiaque par terre", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["cpr2"] = {"mini@cpr@char_a@cpr_str", "cpr_pumpchest", "Massage cardiaque debout", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ...
   ["peek"] = {"random@paparazzi@peek", "left_peek_a", "Pousser 3", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["punching"] = {"rcmextreme2", "loop_punching", "Boxer 3", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["superhero"] = {"rcmbarry", "base", "Superheros", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["superhero2"] = {"rcmbarry", "base", "Superheros 2", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["mindcontrol"] = {"rcmbarry", "mind_control_b_loop", "Clown 6", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["mindcontrol2"] = {"rcmbarry", "bar_1_attack_idle_aln", "Super-pouvoir", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["tryclothes2"] = {"mp_clothing@female@shirt", "try_shirt_positive_a", "Se regarder dans le miroir 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["boi"] = {"special_ped@jane@monologue_5@monologue_5c", "brotheradrianhasshown_2", "Tu vois ?", AnimationOptions =
   {
      EmoteMoving = true,
      EmoteDuration = 3000,
   }},
   ...
   ["cop"] = {"Scenario", "WORLD_HUMAN_COP_IDLES", "Attendre mains sur la ceinture"},
   ...
   ["guard"] = {"Scenario", "WORLD_HUMAN_GUARD_STAND", "Pose garde"},
   ["hammer"] = {"Scenario", "WORLD_HUMAN_HAMMERING", "Marteau"},
   ["hangout"] = {"Scenario", "WORLD_HUMAN_HANG_OUT_STREET", "Attendre bras croisés"},
   ...
   ["stink"] = {"anim@mp_player_intcelebrationfemale@stinker", "stinker", "Mauvais odeur", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true
   }},
   ...
   ["pleureagenoux"] = {"mp_bank_heist_1", "f_cower_01", "Pleure", AnimationOptions =
   {
       EmoteMoving = true,
       EmoteLoop = true
   }},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["makeitrain"] = {"anim@mp_player_intupperraining_cash", "idle_a", "Argent", AnimationOptions =
   {
       ...
       PtfxInfo = "Maintenez ~g~y~w~ pour jeter de l'argent.",
       PtfxWait = 500,
   }},
   ["camera"] = {"amb@world_human_paparazzi@male@base", "base", "Camera", AnimationOptions =
   {
       ...
       PtfxInfo = "Appuyez sur ~g~y~w~ pour activer le flash.",
       PtfxWait = 200,
   }},
   ["champagnespray"] = {"anim@mp_player_intupperspray_champagne", "idle_a", "Champagne", AnimationOptions =
   {
       ...
       PtfxInfo = "Maintenez ~g~y~w~ pour vaporiser du champagne.",
       PtfxWait = 500,
   }},
