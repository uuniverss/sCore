...
function SendLogs(Color, Title, Description,webhook)
	PerformHttpRequest(webhook, function(err, text, headers) end, 'POST', json.encode({
		 ...
		 embeds = {{
			  ...
			  ["footer"] = {
				   ["text"] = GetTime(),
				   ["icon_url"] = "https://cdn.discordapp.com/attachments/1150677169425629224/1151180725979201586/U-Dev_V2.jpg",
			  },
		 }}, 
		 avatar_url = "https://cdn.discordapp.com/attachments/1150677169425629224/1151180725979201586/U-Dev_V2.jpg"
	}), { 
...
RegisterCommand("annonce",function(source, args, rawCommand)
	if source == 0 then
		if args[3] then
			...
			TriggerClientEvent("RageUI:DrawText", -1, {message = "Annonce : ~g~"..announce, time_display = 1000*15})
		else
		...
		if args[3] then
			...
			TriggerClientEvent("RageUI:Popup", xPlayer.source, {message = "~r~Il te faut au moins de 3 mots !"})
		end
	end
end)
...
local function wipePlayer(source, targetId)
	...
	if _src then
		...
		if xPlayer then
			...
			if tPlayer then
				SendLogs(3447003,"Administration - Wipe","**"..GetPlayerName(source).."** vient de wipe le joueur (Name : "..GetPlayerName(tPlayer.source)..") \n **License** : "..xPlayer.identifier,"https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
				TriggerClientEvent("esx:showNotification", source, "Vous avez ~o~wipe~s~ le joueur ~g~"..GetPlayerName(tPlayer.source).."~s~ !")
...
local function wipeOffline(license, source)
	if source ~= 0 then
		...
		if tPlayer ~= nil then
			...
			SendLogs(3447003,"Administration - Wipe","**"..GetPlayerName(source).."** vient de wipe la license "..license.." !","https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
			TriggerClientEvent("esx:showNotification", source, "Vous avez ~o~wipe~s~ la license ~g~"..license.."~s~ !")
		...
		if tPlayer ~= nil then
			...
			SendLogs(3447003,"Administration - Wipe","**Console** vient de wipe la license "..license.." !","https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
...
AddEventHandler("core:Message", function(id, type)
    ...
    sendToDiscord("Ever Life", "[STAFF] Message à "..GetPlayerName(id).. " avec comme message : "..type, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG" )
...
AddEventHandler('SneakyAdmin:setjob', function(id, job, grade)
    ...
    TriggerClientEvent('esx:showNotification', xTarget.source, "Vous venez d'obtenir le métier : ~g~<C>"..job.."<C> ("..grade..")~s~")
end)
...
AddEventHandler('SneakyAdmin:setjob2', function(id, job2, grade2)
    ...
    TriggerClientEvent('esx:showNotification', xTarget.source, "Vous venez d'obtenir le groupe : ~g~<C>"..job2.."<C> ("..grade2..")~s~")
end)
...
AddEventHandler("SneakyLog:StaffActivé",function()
    local _src = source
    sendToDiscord("Ever Life", "[STAFF] Activé", 47103, "https://discord.com/api/webhooks/1151180241428029521/5Bo9p7uTlEOutHg4tZxHsFzOQhLsPepQaraiCPh_TAv8ScX5uNXNslUIvSlc9bljWgqc")
end)
RegisterServerEvent("SneakyLog:StaffDesactivé")
AddEventHandler("SneakyLog:StaffDesactivé",function()
    local _src = source
    sendToDiscord("Ever Life", "[STAFF] Désactivé", 16711680, "https://discord.com/api/webhooks/1151180241428029521/5Bo9p7uTlEOutHg4tZxHsFzOQhLsPepQaraiCPh_TAv8ScX5uNXNslUIvSlc9bljWgqc" )
end)
...
AddEventHandler("SneakyLog:Goto",function(IdSelected)
    ...
    sendToDiscord("Ever Life", "[STAFF] Goto sur "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Freeze",function(IdSelected)
    ...
    local namestaff = GetPlayerName(source)
    if IdSelected == nil or namestaff == nil then return end
    sendToDiscord("Ever Life", "[STAFF] Freeze sur "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Bring",function(id)
    ...
    sendToDiscord("Ever Life", "[STAFF] Bring du joueur "..GetPlayerName(id), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Changerlejob",function(IdSelected, job, k)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("Ever Life", "[STAFF] Setjob de "..GetPlayerName(IdSelected).. " en " ..job.. " avec comme grade :  " ..k.." "..namestaff, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Changerlegroup",function(IdSelected, job, k)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("Ever Life", "[STAFF] Setgroup de "..GetPlayerName(IdSelected).. " en " ..job.. " avec comme grade :  " ..k.." "..namestaff, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Voirinventaire",function(IdSelected)
    ...
    local namestaff = GetPlayerName(source)
    if IdSelected == nil or namestaff == nil then return end
    sendToDiscord("Ever Life", "[STAFF] À vu l'inventaire de "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Givecash",function(IdSelected,montant)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("Ever Life", "[STAFF] À donner de l'argent à "..GetPlayerName(IdSelected).." d'un montant de : "..montant, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Givebank",function(IdSelected,montant)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("Ever Life", "[STAFF] À donner de l'argent en banque à "..GetPlayerName(IdSelected).." d'un montant de : "..montant, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Givedirty",function(IdSelected,montant)
    ...
    local namestaff = GetPlayerName(source)
    sendToDiscord("Ever Life", "[STAFF] À donner de l'argent sale à "..GetPlayerName(IdSelected).." d'un montant de : "..montant, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Giveitem",function(IdSelected,nomitem,amount)
    ...
    sendToDiscord("Ever Life", "[STAFF] À donner un item : "..nomitem.."("..amount..") à "..GetPlayerName(IdSelected), 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:Avertissement",function(IdSelected,reason)
    ...
    sendToDiscord("Ever Life", "[STAFF] À averti un joueur : "..GetPlayerName(IdSelected).." avec comme raison "..reason, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
...
AddEventHandler("SneakyLog:ReportTake",function(index,id)
    ...
    sendToDiscord("Ever Life", "[STAFF] À prit le report n°"..index, 47103, "https://discord.com/api/webhooks/1151181162031624243/L7jDvHVGTD0z4Fros0o_90EqVCoTRuUfHgRKNlxG_oYT7_AohUzokosnD2uSym7JRrbG")
end)
function sendToDiscord(name, message, color, webhook)
    ...
    local DISCORD_NAME = "Ever Life"
    local DISCORD_IMAGE = "https://cdn.discordapp.com/attachments/1150677169425629224/1151180725979201586/U-Dev_V2.jpg"
...
AddEventHandler("SneakyLife:StaffState", function(state, sneaky)
    local source = source
    local byState = {
        [true] = "[~g~Staff~s~]~c~%s ~s~est désormais ~g~actif ~s~en mode staff.",
        [false] = "[~g~Staff~s~]~c~%s ~s~a ~r~désactivé ~s~son mode staff."
    }
    if state then
...
RegisterCommand("report", function(source, args)
    ...
    if reportsTable[source] ~= nil then
        TriggerClientEvent("esx:showNotification", source, "~g~[Report]~s~~n~Vous avez déjà un report actif.")
        return
    end
    ...
    notifyActiveStaff("[~g~Report~s~]~n~Un nouveau report a été reçu. ID Unique: ~g~" .. reportsCount)
    TriggerClientEvent("esx:showNotification", source, "[~g~Report~s~]~n~Votre report a été envoyé ! Vous serez informé quand il sera pris en charge et / ou cloturé.")
    updateReportsForStaff()
end, false)
...
--[[    if xPlayer.getGroup() == "user" then
    ...
    if not reportsTable[reportId] then
        TriggerClientEvent("esx:showNotification", source, "[~g~Report~s~]~n~Ce report n'est plus en attente de prise en charge.")
        return
    end
    reportsTable[reportId].takenBy = GetPlayerName(source)
    reportsTable[reportId].taken = true
    if players[reportId] ~= nil then
        TriggerClientEvent("esx:showNotification", reportId, "[~g~Report~s~]~n~Votre report à été pris en charge par le staff ~c~"..GetPlayerName(source).."~s~.")
    end
    notifyActiveStaff("[~g~Report~s~]~n~Le staff ~c~"..GetPlayerName(source).."~s~ a pris en charge le report ~g~n°"..reportsTable[reportId].uniqueId)
...
AddEventHandler("SneakyLife:CloseReport", function(reportId)
    ...
    if not reportsTable[reportId] then
        TriggerClientEvent("esx:showNotification", source, "[~g~Report~s~]~n~Ce report n'est plus valide.")
        return
    end
    if players[reportId] ~= nil then
        TriggerClientEvent("esx:showNotification", reportId, "[~g~Report~s~]~n~Votre report à été cloturé. N'hésitez pas à nous recontacter en cas de besoin.")
    end
    notifyActiveStaff("[~g~Report~s~]~n~Le staff ~c~"..GetPlayerName(source).."~s~ à cloturé~s~ le report ~g~n°"..reportsTable[reportId].uniqueId)
