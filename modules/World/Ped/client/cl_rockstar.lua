...
RMenu.Add('rockstar', 'main', RageUI.CreateMenu("", "Rockstar ~g~editor~s~", 0, 0,"root_cause","sneakylife"))
...
RegisterNetEvent("sRockstar:Open")
AddEventHandler("sRockstar:Open", function()
