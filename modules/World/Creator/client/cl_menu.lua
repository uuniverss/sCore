...
function OpenCreatorMenu()
    if b.Menu then
        ...
        RMenu.Add('creator', 'identity',
            RageUI.CreateSubMenu(RMenu:Get("creator", "main"), "", "Création d'identité de ~s~ Ever ~g~Life."))
        RMenu.Add('creator', 'character',
            RageUI.CreateSubMenu(RMenu:Get("creator", "main"), "", "Création d'identité de~s~ Ever ~g~Life."))
        RMenu.Add('creator', 'characteroptionsmain', RageUI.CreateSubMenu(RMenu:Get("creator", "character"), "",
            "Création d'identité de ~s~ Ever ~g~Life."))
        ...
        RMenu.Add('creator', 'characteroptions_a',
            RageUI.CreateSubMenu(RMenu:Get("creator", "characteroptionsaccessories"), "",
                "Création d'identité de ~s~ Ever ~g~Life."))
        RMenu:Get('creator', 'main'):SetSubtitle("Création d'identité de ~s~ Ever ~g~Life.")
            ...
            while b.Menu do
                RageUI.IsVisible(RMenu:Get('creator', 'main'), true, false, true, function()
                    ...
                    if sIdentityEnd then
                        RageUI.Button("Créer son identité.", "~s~ Ever ~g~Life.", {
                            RightLabel = "→"
                        }, true, function(k, l, m)
                    ...
                    if sCharEnd then
                        RageUI.Button("Créer son personnage.", "~s~ Ever ~g~Life.", {
                            RightLabel = "→"
                        }, true, function(k, l, m)
                        end, RMenu:Get("creator", "character"))
                    else
                        RageUI.Button("Vous avez terminé votre personnage.", "~s~ Ever ~g~Life.", {
                            RightLabel = "→"
                        }, false, function()
                        end)
                    end
                    if not sIdentityEnd and not sCharEnd then
                        RageUI.Button("Commencer l'aventure.", "~s~ Ever ~g~Life.", {
                            RightLabel = "→",
                            Color = {
                ...
                RageUI.IsVisible(RMenu:Get('creator', 'identity'), true, false, true, function()
                    FreezeEntityPosition(GetPlayerPed(-1), true)
                    RageUI.Button("Prénom", "~s~ Ever ~g~Life.", {
                    ...
                    RageUI.Button("Nom", "~s~ Ever ~g~Life.", {
                    ...
                    RageUI.Button("Taille", "~s~ Ever ~g~Life.", {
                    ...
                    RageUI.Button("Date de naissance", "~s~ Ever ~g~Life.", {
                    ...
                    if sDataIdentity.lastname ~= "" and sDataIdentity.firstname ~= "" and sDataIdentity.height ~= "" and
                        sDataIdentity.birthday ~= "" and sDataIdentity.sex ~= "" then
                        RageUI.Button("Confirmer son identité.", "~s~ Ever ~g~Life.", {
                            RightLabel = "→",
                            Color = {
                                HightLightColor = {0, 158, 255, 160},
                                BackgroundColor = {0, 178, 255, 160}
                            ...
                            if m then
                                sIdentityEnd = false;
                                RageUI.GoBack()
                                AeroEvent('core:CreateIdentity', sDataIdentity)
                                ESX.ShowNotification("~s~ Ever ~g~Life\nIdentité créer avec succès.")
                            end
                        end)
                    end
                end)
                RageUI.IsVisible(RMenu:Get('creator', 'character'), true, false, true, function()
                    ...
                    for x, y in pairs(Components) do
                        if y.name == 'sex' then
                            RageUI.Button(y.label, "~s~ Ever ~g~Life.", {
                                RightLabel = "→"
                            }, true, function(k, l, m)
                                if l then
                                    f = y.zoomOffset;
                    ...
                    RageUI.Button("Visage", "~s~ Ever ~g~Life.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Apparence", "~s~ Ever ~g~Life.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Vetements", "~s~ Ever ~g~Life.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Accessoires", "~s~ Ever ~g~Life.", {
                        RightLabel = "→"
                    }, true, function(k, l, m)
                        if m then
                            GetComponents()
                    ...
                    RageUI.Button("Terminer son personnage.", "~s~ Ever ~g~Life.", {
                        RightLabel = "→",
                        Color = {
                            HightLightColor = {0, 158, 255, 160},
                            BackgroundColor = {0, 178, 255, 160}
                    ...
                    for z, y in pairs(Components) do
                        if y.name == sData then
                            for B = 0, ComponentsMax[sData] do
                                RageUI.Button(y.label .. " N°" .. B, "~s~ Ever ~g~Life.", {
                                    RightLabel = "→"
                                }, true, function(k, l, m)
                                    if l then
                                        if sLoaded ~= B then
...
function StartCreatorEndCinematic()
    ...
    Destroy("cin_music")
    AeroEvent('instancecreator:reset', 0)
end
