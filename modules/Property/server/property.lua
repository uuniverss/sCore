...
sPropertyManager.Keys = {
    ...
    groupList = {
        ...
        ["boneli"] = {label = "Boneli"},
        ["Blackweather"] = {label = "Blackweather"},
        ["armadas"] = {label = "Fuerzas Armadas"},
        ["turkish"] = {label = "Mafia Turkish"},
    },
}
    ...
    if xPlayer then
        ...
        if type == "item" then
            ...
            if exist then
                ...
                TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez ajouté ~g~x"..count.." de "..ESX.GetItemLabel(name).."~s~ qui vous fais au total (~g~x"..lastCount+count.." "..ESX.GetItemLabel(name).."~s~) !")
                lastCount = 0
                exist = false
            else
                xPlayer.removeInventoryItem(name, count)
                ...
                TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez ajouté ~g~x"..count.." de "..ESX.GetItemLabel(name).."~s~ !")
            end
        ...
        elseif type == "weapon" then
            ...
            TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez déposé ~g~un(e) "..infoWeapon.label.."~s~ avec ~o~"..ammo.."munition(s)~s~ !")
        end
    ...
    if xPlayer then
        ...
        if count > niceCount then
            ...
            elseif type == "item" then
                ...
                TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez retirer ~g~x"..count.." de "..ESX.GetItemLabel(name).."~s~ !")
                TriggerClientEvent("sProperty:returnInventory", xPlayer.source, sPropertyManager.list[propertyId].inventory)
                niceCount = 0
                niceKle = 0
                exist = false
            elseif type == "weapon" then
			    ...
			    if xPlayer.hasWeapon(itemName) then
                    ...
                    TriggerClientEvent("esx:showNotification", xPlayer.source, "Vous avez retirer ~g~x"..count.." de "..ESX.GetWeaponLabel(name).."~s~ avec ~o~"..ammo.."munition(s)~s~ !")
                    TriggerClientEvent("sProperty:returnInventory", xPlayer.source, sPropertyManager.list[propertyId].inventory)
                    niceCount = 0
                    niceKle = 0
                    exist = false
...
AddEventHandler("sProperty:addKeysAccess", function(propertyId, type, label, name)
    ...
    if type == "jobList" then
        ...
        TriggerClientEvent("esx:showNotification", source, "Vous avez donné les clé au métier ~g~"..label.."~s~ !")
    ...
    elseif type == "groupList" then
        ...
        TriggerClientEvent("esx:showNotification", source, "Vous avez donné les clé au groupe ~g~"..label.."~s~ !")
        TriggerClientEvent("sProperty:returnCallBackKeys", -1, sPropertyManager.list[propertyId].keys)
        TriggerClientEvent("sProperty:returnPlayerAcces", -1, propertyId, nil)
        onRequest = false
        nice = true
    elseif type == "person" then
        if name then
            ...
            if player then
                ...
                TriggerClientEvent("esx:showNotification", source, "Vous avez donné les clé à ~g~"..player.name.."~s~ !")
                TriggerClientEvent("sProperty:returnCallBackKeys", -1, sPropertyManager.list[propertyId].keys)
...
AddEventHandler("sProperty:removeKeysAccess", function(propertyId, type, label, name)
    ...
    if type == "jobList" then
        if sPropertyManager.Keys.jobList[name] == nil then return end
        TriggerClientEvent("esx:showNotification", source, "Vous avez retiré les clé au métier ~g~"..label.."~s~ !")
        TriggerClientEvent("sProperty:returnPlayerAcces", -1, propertyId, nil)
        onRequest = false
        nice = true
    elseif type == "groupList" then
        if sPropertyManager.Keys.groupList[name] == nil then return end
        TriggerClientEvent("esx:showNotification", source, "Vous avez retiré les clé au groupe ~g~"..label.."~s~ !")
        TriggerClientEvent("sProperty:returnPlayerAcces", -1, propertyId, nil)
        onRequest = false
        nice = true
    elseif type == "person" then
        if name then
            ...
            if player then
                TriggerClientEvent("esx:showNotification", source, "Vous avez retiré les clé à ~g~"..label.."~s~ !")
...
AddEventHandler("sProperty:exitProperty", function(propertyId)
    ...
    if xPlayer then
        ...
        exports.es_extended:onSavedPlayer(true, xPlayer.identifier)
    end
...
local cbRequest
RegisterServerEvent("requestInvitePlayer")
AddEventHandler("sProperty:requestInvitePlayer", function(propertyId, owner)
    ...
    if xPlayer then
        ...
        TriggerClientEvent("esx:showNotification", source, "~g~Sonnette~s~~n~Vous avez envoyer une demande !")
        ...
        if cbRequest == true then
            Property:enter(xPlayer.source, propertyId, owner)
            TriggerClientEvent("esx:showNotification", xPlayer.source, "Inviation~n~Le ~g~propriétaire~s~ à accepté votre invitation !")
        else
            TriggerClientEvent("esx:showNotification", xPlayer.source, "Inviation~n~Le ~g~propriétaire~s~ à refusé votre invitation !")
        end
