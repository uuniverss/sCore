...
function TebexSendWebhook(steam, message, transaction)
    ...
    SendLogs(15105570,"Boutique - Achat","**"..GetPlayerName(source).."** vient d'acheter une ***"..message.."*** avec comme transaction : ***"..transaction.."***\n **License** : "..xPlayer.identifier,"https://discord.com/api/webhooks/1043186446464454676/lbfWp5b3L9VUkHhVfqE1_9u0RaUQbCoQ_sai2TvGRxqxL4DxId9UvkpMqL4DVh0wdzvC")
end
...
RegisterCommand('addVip', function(source, args)
    ...
    Citizen.CreateThread(function()
        ...
        if vipRank == 1 then vipLabel = "VIP ~g~Gold~s~." money = 15000 elseif vipRank == 2 then vipLabel = "VIP ~g~Diamond~s~." money = 30000 end
        ...
        if not online then
            MySQL.Async.fetchAll('SELECT * FROM account_info WHERE fivem = @fivem',{
                ...
                if result[1] then
                    ...
                    exports.sCore:SendLogs(1752220,"Vip - Ajout Offline",""..result[1].name.." vient de prendre son "..vipLabel.." \n License : "..result[1].license,"https://discord.com/api/webhooks/1043186446464454676/lbfWp5b3L9VUkHhVfqE1_9u0RaUQbCoQ_sai2TvGRxqxL4DxId9UvkpMqL4DVh0wdzvC")
    ...
    Citizen.CreateThread(function()
        ...
        for i=1, #xPlayers, 1 do
            ...
            if fivem == fivemPlayer then
                ...
                exports.sCore:SendLogs(1752220,"Vip - Remove",""..xPlayer.name.." vient de perdre son VIP \n License : "..xPlayer.identifier,"https://discord.com/api/webhooks/1043186655080742933/ElmMEiqM78D9rU9f2ZUfhTgFrsKo5LuQoTEZD8xmd-8nhG8l4Pl3uvj4hQea0pub_Kfc")
            end
        end
    end)
    exports.sCore:SendLogs(1752220,"Vip - Remove",""..fivem.." vient de perdre son VIP : **"..vipRank.."**","https://discord.com/api/webhooks/1043186655080742933/ElmMEiqM78D9rU9f2ZUfhTgFrsKo5LuQoTEZD8xmd-8nhG8l4Pl3uvj4hQea0pub_Kfc")
end)
